...
MERGE (journal:Journal {name: 'Tạp chí Khoa học Đại học Sài Gòn', description: 'Tạp chí Khoa học Đại học Sài Gòn phục vụ cán bộ giảng dạy, nghiên cứu, quản lý, sinh viên các trường đại học, cao đẳng, các viện, học viện, các trung tâm nghiên cứu.'})
MERGE (journalPurpose:Journal {name: 'Tôn chỉ, mục đích hoạt động', description: 'Là diễn đàn khoa học công bố các kết quả nghiên cứu và hoạt động khoa học của cán bộ, giảng viên trường Đại học Sài Gòn.'})

WITH university, journal, journalPurpose

MERGE (university)-[:publishesIn]->(journal)
MERGE (journal)-[:hasPurpose]->(journalPurpose)

MERGE (submissionGuidelines:Journal {name: 'Quy định chung về bài báo khoa học', description: 'Các bài báo phải nêu rõ mục tiêu nghiên cứu, có kết quả mới, được phản biện và có danh mục chú thích và tài liệu tham khảo.'})
MERGE (submissionFormat:Journal {name: 'Thể lệ gửi bài đăng', description: 'Bài gửi đăng phải là công trình khoa học, chưa từng công bố trong ấn phẩm khác, được viết bằng tiếng Việt hoặc tiếng Anh.'})

WITH journal, submissionGuidelines, submissionFormat

MERGE (journal)-[:hasSubmissionGuidelines]->(submissionGuidelines)
MERGE (journal)-[:hasSubmissionFormat]->(submissionFormat)