...
def generate_ontology_from_cqs(
    ...
    system_prompt = (
        ...
        "5. Đầu ra phải là mã Turtle thuần túy, khai báo các prefix chuẩn (ví dụ: @prefix : <http://sgu.edu.vn/ontology#> .),  và không chứa bất kỳ lời giải thích, chú thích, hay định dạng markdown nào.\n\n"
    ...
    2. Các thuộc tính (Properties) – kèm theo domain và range phù hợp, thể hiện mối quan hệ giữa các lớp.
    3. Các mối quan hệ giữa các lớp – thể hiện cách các lớp liên kết với nhau theo ngữ cảnh của câu hỏi.

    Trả ra kết quả là mã Turtle thuần túy, không có lời giải thích, chú thích hay định dạng markdown nào.
    """
...
# Gọi hàm để tạo ontology từ các câu hỏi trong thư mục "Qc"
generate_ontology_from_cqs(qc_folder="Qc", output_path="./ontology/ontology_generated.ttl", model="gpt-4o-mini")
