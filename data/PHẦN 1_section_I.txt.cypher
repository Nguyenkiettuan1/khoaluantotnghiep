...
MERGE (program2:Program {name: "Giáo dục thường xuyên", description: "Phương thức đào tạo giáo dục thường xuyên bao gồm: vừa làm vừa học, văn bằng hai, liên thông"})
...
MERGE (accreditation:Kiem_dinh {name: "Kiểm định chất lượng giáo dục", description: "Chứng nhận kiểm định chất lượng giáo dục trường đại học được cấp ngày 13/5/2017"})
