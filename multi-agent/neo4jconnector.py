    ...
    def generate_answer(self, query: str, search_results: List[Dict]) -> str:
        ...
        try:
            ...
            messages = [
                ...
                3. Trình bày câu trả lời một cách rõ ràng, mạch lạc và chuyên nghiệp
                4. Nếu thấy thông tin mâu thuẫn giữa các kết quả, hãy nêu rõ điều này
                5. Nếu câu hỏi yêu cầu thông tin cụ thể (như số lượng, địa điểm, thời gian) mà không tìm thấy trong kết quả, hãy nói rõ là không có thông tin này
                6. Khi đề cập đến học bổng hoặc thông tin quan trọng, hãy cung cấp thông tin chi tiết từ kết quả tìm kiếm, không đưa ra giả định
                7. Hãy phân tích độ tin cậy của thông tin dựa trên độ tương đồng trước khi đưa ra câu trả lời
                ...
                ** Chú ý khi trả lời **
                - Câu trả lời phải phù hợp với câu hỏi và sử dụng thông tin từ kết quả tìm kiếm.
